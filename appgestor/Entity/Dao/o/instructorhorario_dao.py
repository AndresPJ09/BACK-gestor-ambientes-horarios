...
class InstructorHorarioDAO:
    ...
    def obtener_todos_los_horarios():
        with connection.cursor() as cursor:
            cursor.execute("""
                SELECT IH.id AS instructorhorario_id,
                ...
                LEFT JOIN sena.Programa AS PR ON H.programa_id = PR.id
                LEFT JOIN sena.NivelFormacion AS N ON H.nivelformacion_id = N.id
